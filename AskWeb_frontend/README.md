Questo progetto è stato generato utilizzando lo strumento [ng-chrome](https://github.com/larscom/ng-chrome-extension) per la creazione di estensioni Chrome con Angular.
